    ...
    def __init__(self, ui: UserInterface.UserInterface) -> None:
        ...
        def handle_clicked() -> None:
            if self.__window:
                ...
                pos = window_pos + self.__row.map_to_root_container(Geometry.IntPoint(y=y_pos))
...
class BoxWidgetBehavior(WidgetBehavior):
    ...
    def __init__(self, is_row: bool, properties: typing.Optional[typing.Mapping[str, typing.Any]]) -> None:
    ...
    def insert(self, child: UserInterface.Widget, index: typing.Optional[typing.Union[UserInterface.Widget, int]],
        ...
        # TODO: fill
        alignment_canvas_item = CanvasItem.CanvasItemComposition()
        alignment_canvas_item.layout = CanvasItem.CanvasItemColumnLayout() if self.__is_row else CanvasItem.CanvasItemRowLayout()
        child_canvas_item = extract_canvas_item(child)
        assert self.widget is not None
        assert child_canvas_item is not None
        index = index if index is not None else len(self.__box_canvas_item.canvas_items)
        if alignment in ('right', 'top', 'hcenter', 'vcenter', 'center'):
            alignment_canvas_item.add_stretch()
        alignment_canvas_item.add_canvas_item(child_canvas_item)
        if alignment in ('left', 'bottom', 'hcenter', 'vcenter', 'center') or alignment is None:
            alignment_canvas_item.add_stretch()
        self.__box_canvas_item.insert_canvas_item(typing.cast(int, index), alignment_canvas_item)
...
class PushButtonWidgetBehavior(WidgetBehavior):
    ...
    def __init__(self, ui: CanvasUserInterface, properties: typing.Optional[typing.Mapping[str, typing.Any]]) -> None:
        ...
        self.__canvas_item.add_canvas_item(self.__push_button_widget_canvas_item_controller.widget_source.canvas_item)
...
class CanvasUserInterface(UserInterface.UserInterface):
    ...
    def create_row_widget(self, alignment: typing.Optional[str] = None, properties: typing.Optional[typing.Mapping[str, typing.Any]] = None) -> UserInterface.BoxWidget:
        return UserInterface.BoxWidget(BoxWidgetBehavior(True, properties), alignment)
    ...
    def create_column_widget(self, alignment: typing.Optional[str] = None, properties: typing.Optional[typing.Mapping[str, typing.Any]] = None) -> UserInterface.BoxWidget:
        return UserInterface.BoxWidget(BoxWidgetBehavior(False, properties), alignment)
    ...
    def create_push_button_widget(self, text: typing.Optional[str] = None, properties: typing.Optional[typing.Mapping[str, typing.Any]] = None) -> UserInterface.PushButtonWidget:
        behavior = PushButtonWidgetBehavior(self, properties)
        if text is not None:
            behavior.text = text
